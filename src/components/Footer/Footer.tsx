        ...
        <nav className="footer-nav">
          ...
          <ul className="navigation">
            <li className="navigation__item">
              <a className="navigation__item__link" href="#app">
                Features
              </a>
            </li>
            <li className="navigation__item">
          ...
          <ul className="navigation navigation--sns">
            <li className="navigation__item">
              <a href="#app" className="sns-icon" aria-labelledby="Facebook">
                <FacebookIcon />
              </a>
            </li>
            <li className="navigation__item">
              <a href="#app" className="sns-icon" aria-labelledby="Twitter">
                <TwitterIcon />
              </a>
            </li>
          </ul>
